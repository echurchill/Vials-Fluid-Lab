...
git show 1f515c2:Vials/FluidLab/LabFluid2DView.swift | sed 's/struct LabFluid2DView:View/struct LabFluid2DBaselineView:View/' > "$lab_output/BaselineView.swift"

...
macOS and signed iOS builds passed. Live Mac checks verified choosing a six-vial level, switching presentations, pouring A→F and undo. The Mac subsequently locked; the final relocated options-menu click-through and subjective sound/haptic review remain for the next manual play check. Portrait board captures were inspected. Build success and sound-file decoding do not establish subjective sound quality or prove that an iPad has haptic hardware.
